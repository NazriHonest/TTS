...
class ApiService {
  ...
  List<AudioModel> _getLocalMockList() {
    return [
      AudioModel(
        id: 'local-001',
        text: 'Welcome to VoxAI, your personal text-to-speech assistant.',
        audioUrl: AppConstants.sampleAudioUrl,
        voice: 'female_1',
        language: 'en-US',
        speed: 1.0,
      ...
      AudioModel(
        id: 'local-003',
        text: 'Artificial intelligence is transforming the way we communicate.',
        audioUrl: AppConstants.sampleAudioUrl,
        voice: 'female_2',
        language: 'en-GB',
        speed: 0.8,
      ...
      AudioModel(
        id: 'local-004',
        text: 'Buenos dias, esta es una prueba de texto a voz.',
        audioUrl: AppConstants.sampleAudioUrl,
        voice: 'male_2',
        language: 'es-ES',
        speed: 1.2,
      ...
      AudioModel(
        id: 'local-005',
        text: 'Learning new languages opens doors to the world.',
        audioUrl: AppConstants.sampleAudioUrl,
        voice: 'female_1',
        language: 'en-US',
        speed: 1.0,
